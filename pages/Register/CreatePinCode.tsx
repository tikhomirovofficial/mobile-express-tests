            ...
            <View style={[cs.fColumn, cs.spaceM, { minHeight: "100%", }]}>
                <WhiteBorderedLayout
                    topContent={
                        <AppContainer style={{ paddingBottom: 0 }}>
                            <View style={[cs.fCenterCol]}>
                                <Text style={[cs.fwSemi, cs.fwSemi, cs.fzXL, { color: theme.title }]}>Создайте пин-код</Text>
                            </View>
                        </AppContainer>
                    }
                    ...
                    <View style={[cs.fColumnBetw, { paddingBottom: 32, height: "100%" }]}>
                        ...
                        <View style={[cs.fColumn, cs.fAlCenter, cs.spaceXXL, styles.pinTable]}>
                            <View style={[cs.fColumn, cs.spaceL, { maxWidth: "85%" }]}>
                                <View style={[cs.fRowBetw, cs.spaceXXL]}>
