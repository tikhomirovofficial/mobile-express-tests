...
export const CategoryOrProductItem: FC<CategoryOrProductItem> = React.memo(({ item, toProducts, cartProducts }) => {
    ...
    return <ProductItem product={itemTyped as AnalysisApi} index={item.id} isInCart={cartProducts.some(cartProduct => cartProduct.id === item.id)} />
